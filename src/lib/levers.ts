...
export const MOVES: Move[] = [
  ...
  },
  {
    ...
    candidate: { en: "Retailor your CV for the European market. It is the first thing an employer sees, and format alone filters people out.", th: "ปรับ CV ให้เข้ากับตลาดงานยุโรป เพราะนี่มักเป็นสิ่งแรกที่นายจ้างเห็น ต่อให้ประสบการณ์ดี แต่ถ้ารูปแบบหรือเนื้อหาไม่ตรงกับที่เขาคุ้นเคย ก็อาจถูกมองข้ามได้" },
  ...
  },
  {
    ...
    candidate: { en: "Wake up your LinkedIn. European recruiters search there directly, and a quiet profile is invisible to them.", th: "กลับมาอัปเดต LinkedIn ให้มีความเคลื่อนไหว รีครูตเตอร์ในยุโรปใช้ช่องทางนี้ค้นหาผู้สมัครโดยตรง โปรไฟล์ที่ไม่ได้อัปเดตเลยจึงมีโอกาสถูกเห็นน้อยลง" },
  ...
  },
  {
    ...
    candidate: { en: "Spend one session learning what working in Europe legally requires. It is the single fastest gap to close.", th: "กันเวลาศึกษากฎและเงื่อนไขการทำงานในประเทศเป้าหมาย เรื่องนี้อาจดูซับซ้อน แต่ยิ่งรู้เร็ว ก็ยิ่งวางแผนเรื่องอื่นได้ตรงขึ้น" },
  ...
  },
  {
    ...
    candidate: { en: "Work out a salary expectation for your target country, with currency and period. It anchors every later conversation.", th: "หาข้อมูลช่วงเงินเดือนของตำแหน่งที่สนใจในประเทศเป้าหมาย แล้วกำหนดตัวเลขที่คาดหวังให้ชัด อย่าลืมระบุสกุลเงินและคิดเป็นรายเดือนหรือรายปี เพื่อใช้เป็นจุดอ้างอิงในการคุยครั้งต่อไป" },
  ...
  },
  {
    ...
    candidate: { en: "Put two or three pieces of your work somewhere an employer can see them. Evidence argues better than adjectives.", th: "เลือกผลงานที่ดีที่สุด 2–3 ชิ้น แล้วนำไปไว้ในที่ที่นายจ้างเปิดดูได้ง่าย ผลงานจริงช่วยให้เห็นความสามารถของคุณชัดกว่าคำบรรยายเพียงอย่างเดียว" },
  ...
  },
  {
    ...
    candidate: { en: "Start a steady English routine aiming at fluent professional level. It moves slowly, which is exactly why starting now matters.", th: "ฝึกภาษาอังกฤษอย่างสม่ำเสมอ โดยตั้งเป้าให้ใช้ทำงานได้คล่องขึ้น ทักษะนี้ต้องใช้เวลา จึงควรเริ่มฝึกตั้งแต่ตอนนี้" },
  ...
  },
  {
    ...
    candidate: { en: "Make AI research a weekly habit: companies, visa rules, salary ranges, one hour, every week.", th: "ลองกันเวลาสัปดาห์ละ 1 ชั่วโมงให้ AI ช่วยค้นคว้าเรื่องบริษัท กฎวีซ่า และช่วงเงินเดือน แล้วตรวจสอบข้อมูลสำคัญกับแหล่งข้อมูลต้นทางทุกครั้ง" },
  ...
  },
  {
    ...
    candidate: { en: "Get hands-on with Slack, Teams, and Notion. These tools are common in European workplaces.", th: "ฝึกใช้ Slack, Teams และ Notion ให้คุ้นมือ เพราะเป็นเครื่องมือที่พบได้บ่อยในทีมและองค์กรยุโรป" },
  ...
  },
  {
    ...
    candidate: { en: "Use AI to tailor your CV and cover letter to each specific role instead of sending one version everywhere.", th: "ใช้ AI ช่วยปรับ CV และจดหมายสมัครงานให้เข้ากับแต่ละตำแหน่ง แล้วตรวจทานด้วยตัวเองก่อนส่ง แทนการใช้เอกสารฉบับเดียวสมัครทุกงาน" },
  ...
  },
  {
    ...
    candidate: { en: "Choose one job-search tool yourself, such as an application tracker, and make it part of your routine.", th: "เลือกเครื่องมือใหม่มาลองใช้ด้วยตัวเองสักหนึ่งอย่าง เช่น เครื่องมือติดตามใบสมัคร แล้วใช้ต่อเนื่องจนคล่อง โดยไม่ต้องรอให้มีใครมาบอกว่าควรเริ่มเมื่อไร" },
