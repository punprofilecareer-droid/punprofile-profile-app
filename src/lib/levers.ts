...
export const MOVES: Move[] = [
  {
    ...
    candidate: { en: "Pick one country and one role to aim at first. Everything after this step gets easier once it is specific.", th: "เลือกประเทศเดียวและตำแหน่งเดียวเป็นเป้าหมายแรกก่อน ทุกขั้นตอนหลังจากนี้จะง่ายขึ้นเมื่อเป้าหมายชัด" },
  ...
  },
  {
    ...
    candidate: { en: "Retailor your CV for the European market. It is the first thing an employer sees, and format alone filters people out.", th: "ปรับ CV ให้เหมาะกับตลาดยุโรป CV คือสิ่งแรกที่บริษัทเห็น และแค่รูปแบบไม่ตรงก็ทำให้ตกรอบได้" },
  ...
  },
  {
    ...
    candidate: { en: "Wake up your LinkedIn. European recruiters search there directly, and a quiet profile is invisible to them.", th: "กลับมาอัปเดต LinkedIn ให้มีความเคลื่อนไหว recruiter ในยุโรปค้นหาคนจากที่นั่นโดยตรง โปรไฟล์ที่เงียบอยู่จะไม่ถูกมองเห็น" },
  ...
  },
  {
    ...
    candidate: { en: "Find and name the specific visa route you would use. Knowing the route changes which employers are even worth applying to.", th: "หาให้เจอว่าคุณจะใช้วีซ่าประเภทไหน รู้ประเภทวีซ่าแล้วจะเปลี่ยนไปเลยว่าบริษัทไหนคุ้มที่จะสมัคร" },
  ...
  },
  {
    ...
    candidate: { en: "Spend one session learning what working in Europe legally requires. It is the single fastest gap to close.", th: "ใช้เวลาสักรอบศึกษาว่าการทำงานในยุโรปต้องใช้อะไรบ้างตามกฎหมาย นี่คือช่องว่างที่ปิดได้เร็วที่สุด" },
  ...
  },
  {
    ...
    candidate: { en: "Work out a salary expectation for your target country, with currency and period. It anchors every later conversation.", th: "กำหนดเงินเดือนที่คาดหวังสำหรับประเทศเป้าหมาย ระบุสกุลเงินและต่อเดือนหรือต่อปีให้ชัด ตัวเลขนี้จะเป็นหลักในการคุยทุกครั้งต่อจากนี้" },
  ...
  },
  {
    ...
    candidate: { en: "Put two or three pieces of your work somewhere an employer can see them. Evidence argues better than adjectives.", th: "เอาผลงานสักสองสามชิ้นไปไว้ในที่ที่บริษัทเข้าไปดูได้ ผลงานจริงน่าเชื่อกว่าคำบรรยายตัวเอง" },
  ...
  },
  {
    ...
    candidate: { en: "Send your first five targeted applications and track each one. Nothing downstream starts until these go out.", th: "ลองสมัครงานที่ตรงเป้าจริงๆ สัก 5 ตำแหน่งแรก แล้วจดบันทึกไว้ทุกตำแหน่ง ขั้นตอนถัดไปจะยังไม่เริ่มจนกว่าใบสมัครจะออกไป" },
  ...
  },
  {
    ...
    candidate: { en: "Start a steady English routine aiming at fluent professional level. It moves slowly, which is exactly why starting now matters.", th: "เริ่มฝึกภาษาอังกฤษอย่างสม่ำเสมอ ตั้งเป้าให้ใช้ทำงานได้คล่อง ทักษะนี้ขยับช้า ซึ่งเป็นเหตุผลที่ควรเริ่มตั้งแต่ตอนนี้" },
  ...
  // single indicator is guesswork, so the whole stack is one onboarding move.
  {
    ...
    candidate: { en: "Set up your AI job-search toolkit: weekly AI research, the workplace tools European teams use, AI-tailored applications, and one tracker you pick yourself.", th: "จัดชุดเครื่องมือ AI สำหรับหางานของคุณเอง ใช้ AI หาข้อมูลทุกสัปดาห์ ใช้เครื่องมือที่ทีมในยุโรปใช้กันจริง ปรับใบสมัครด้วย AI และเลือก tracker สักตัวที่คุณถนัด" },
  ...
  },
  {
    ...
    candidate: { en: "Make AI research a weekly habit: companies, visa rules, salary ranges, one hour, every week.", th: "ทำให้การหาข้อมูลด้วย AI เป็นนิสัยประจำสัปดาห์ ทั้งบริษัท กฎวีซ่า และช่วงเงินเดือน สัปดาห์ละหนึ่งชั่วโมง" },
  ...
  },
  {
    ...
    candidate: { en: "Get hands-on with Slack, Teams and Notion. They are the default furniture of a European office.", th: "ลองใช้ Slack, Teams และ Notion ให้คล่อง เครื่องมือพวกนี้คือของพื้นฐานในออฟฟิศยุโรป" },
  ...
  },
  {
    ...
    candidate: { en: "Use AI to tailor your CV and cover letter to each specific role instead of sending one version everywhere.", th: "ใช้ AI ปรับ CV และจดหมายสมัครงานให้ตรงกับแต่ละตำแหน่ง แทนที่จะส่งฉบับเดียวไปทุกที่" },
  ...
  },
  {
    ...
    candidate: { en: "Pick one tool nobody told you to use, an application tracker is the obvious one, and make it yours.", th: "เลือกเครื่องมือสักตัวที่ไม่มีใครสั่งให้ใช้ แล้วใช้ให้เป็นของตัวเอง tracker สำหรับติดตามใบสมัครเป็นตัวเลือกที่ชัดที่สุด" },
