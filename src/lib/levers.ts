...
export const MOVES: Move[] = [
  ...
  },
  {
    ...
    candidate: { en: "Retailor your CV for the European market. It is the first thing an employer sees, and format alone filters people out.", th: "ปรับ CV ให้ตรงกับตลาดงานยุโรป เพราะนี่คือสิ่งแรกที่นายจ้างเห็น และแค่รูปแบบไม่เหมาะก็อาจทำให้ตกรอบได้" },
  ...
  },
  {
    ...
    candidate: { en: "Wake up your LinkedIn. European recruiters search there directly, and a quiet profile is invisible to them.", th: "ทำให้ LinkedIn ของคุณกลับมามีความเคลื่อนไหว รีครูตเตอร์ในยุโรปค้นหาผู้สมัครจากที่นี่โดยตรง โปรไฟล์ที่เงียบจึงแทบไม่มีใครเห็น" },
  ...
  },
  {
    ...
    candidate: { en: "Find and name the specific visa route you would use. Knowing the route changes which employers are even worth applying to.", th: "ระบุประเภทวีซ่าที่คุณจะใช้ให้ชัด เพราะข้อมูลนี้จะช่วยให้รู้ว่าบริษัทไหนมีโอกาสและควรสมัคร" },
  ...
  },
  {
    ...
    candidate: { en: "Spend one session learning what working in Europe legally requires. It is the single fastest gap to close.", th: "แบ่งเวลาศึกษาข้อกำหนดทางกฎหมายสำหรับการทำงานในยุโรป นี่เป็นเรื่องสำคัญที่เรียนรู้และเตรียมให้พร้อมได้เร็วที่สุด" },
  ...
  },
  {
    ...
    candidate: { en: "Work out a salary expectation for your target country, with currency and period. It anchors every later conversation.", th: "กำหนดเงินเดือนที่คาดหวังสำหรับประเทศเป้าหมาย พร้อมระบุสกุลเงินและหน่วยเวลา เช่น ต่อเดือนหรือต่อปี ตัวเลขนี้จะเป็นจุดอ้างอิงในการพูดคุยครั้งต่อๆ ไป" },
  ...
  },
  {
    ...
    candidate: { en: "Put two or three pieces of your work somewhere an employer can see them. Evidence argues better than adjectives.", th: "นำผลงาน 2–3 ชิ้นไปไว้ในที่ที่นายจ้างเข้าดูได้ เพราะผลงานจริงพิสูจน์ความสามารถได้ดีกว่าคำบรรยาย" },
  ...
  },
  {
    ...
    candidate: { en: "Send your first five targeted applications and track each one. Nothing downstream starts until these go out.", th: "สมัครงานที่ตรงเป้าหมาย 5 ตำแหน่งแรก และบันทึกติดตามทุกตำแหน่ง ขั้นตอนต่อไปจะเริ่มไม่ได้จนกว่าคุณจะส่งใบสมัครออกไปจริง" },
  ...
  },
  {
    ...
    candidate: { en: "Start a steady English routine aiming at fluent professional level. It moves slowly, which is exactly why starting now matters.", th: "เริ่มฝึกภาษาอังกฤษอย่างสม่ำเสมอ โดยตั้งเป้าให้ใช้ทำงานได้อย่างคล่องแคล่ว ทักษะนี้ต้องใช้เวลา และนั่นยิ่งเป็นเหตุผลว่าทำไมคุณจึงควรเริ่มตั้งแต่ตอนนี้" },
  ...
  // single indicator is guesswork, so the whole stack is one onboarding move.
  {
    ...
    candidate: { en: "Set up your AI job-search toolkit: weekly AI research, the workplace tools European teams use, AI-tailored applications, and one tracker you pick yourself.", th: "จัดชุดเครื่องมือ AI สำหรับการหางานของคุณ ใช้ AI ค้นคว้าทุกสัปดาห์ ฝึกใช้เครื่องมือที่ทีมยุโรปนิยม ใช้ AI ปรับใบสมัครให้ตรงกับแต่ละงาน และเลือกเครื่องมือติดตามการสมัครงานที่เหมาะกับคุณ" },
  ...
  },
  {
    ...
    candidate: { en: "Make AI research a weekly habit: companies, visa rules, salary ranges, one hour, every week.", th: "ทสร้างนิสัยใช้ AI ค้นคว้าสัปดาห์ละ 1 ชั่วโมง ทั้งเรื่องบริษัท กฎวีซ่า และช่วงเงินเดือน" },
  ...
  },
  {
    ...
    candidate: { en: "Get hands-on with Slack, Teams, and Notion. These tools are common in European workplaces.", th: "ฝึกใช้ Slack, Teams และ Notion ให้คล่อง เพราะเครื่องมือเหล่านี้เป็นพื้นฐานที่พบได้ทั่วไปในออฟฟิศยุโรป" },
  ...
  },
  {
    ...
    candidate: { en: "Use AI to tailor your CV and cover letter to each specific role instead of sending one version everywhere.", th: "ใช้ AI ปรับ CV และจดหมายสมัครงานให้ตรงกับแต่ละตำแหน่ง แทนที่จะใช้ฉบับเดียวสมัครทุกงาน" },
  ...
  },
  {
    ...
    candidate: { en: "Choose one job-search tool yourself, such as an application tracker, and make it part of your routine.", th: "เลือกเครื่องมือมาใช้ด้วยตัวเองสักหนึ่งอย่างโดยไม่ต้องรอให้ใครบอก เครื่องมือติดตามใบสมัครเป็นตัวเลือกที่เหมาะ แล้วฝึกใช้ให้คล่อง" },
